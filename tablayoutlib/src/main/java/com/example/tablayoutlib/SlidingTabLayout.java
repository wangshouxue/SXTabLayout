...
/**
 * @author:wangshouxue
 * @date:2019-10-14 08:38
 * @description:滑动TabLayout,对于ViewPager的依赖性强,适用于新闻类很多频道的顶部tab
 */
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener{
    ...
    private float mCurrentPositionOffset;//当前view的偏移量比例
    /** 用于绘制显示器 */
    ...
    private boolean mIndicatorWidthEqualTitle;//指示器和title宽度是否一样
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.layout_slidingtab, null);
...
//                        }
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, R.layout.layout_slidingtab, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
