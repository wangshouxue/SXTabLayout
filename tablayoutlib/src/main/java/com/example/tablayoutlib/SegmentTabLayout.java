...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener{
    ...
    private boolean mIndicatorAnimEnable;//跟椭圆指示器有关，指示器的移动是依靠动画实现的
    ...
    private int mBarColor;//未选中的填充色
    private int mBarStrokeColor;//未选中的边框色
    private float mBarStrokeWidth;//未选中的边框宽
    /** anim */
    ...
    private void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            TextView tv_tab_title = tabView.findViewById(R.id.tv_tab_title);
            LinearLayout ll = tabView.findViewById(R.id.ll_tap);
